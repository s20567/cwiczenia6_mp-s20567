...
namespace cwiczenia_6.Migrations
{
    ...
    [Migration("20220601221758_AddSeed")]
            ...
            modelBuilder.Entity("cwiczenia_6.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2022, 6, 2, 0, 17, 58, 526, DateTimeKind.Local).AddTicks(895),
                            FirstName = "Ola",
                            LastName = "Nowak"
                        });
                });
            ...
            modelBuilder.Entity("cwiczenia_6.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2022, 6, 2, 0, 17, 58, 526, DateTimeKind.Local).AddTicks(954),
                            DueDate = new DateTime(2023, 3, 2, 0, 17, 58, 526, DateTimeKind.Local).AddTicks(956),
                            IdDoctor = 2,
                            IdPatient = 1
                        });
                });
